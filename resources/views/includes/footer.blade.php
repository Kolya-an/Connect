<footer>
    <div class="container">
        ...
        <p class="footer_disclamer" style="text-align: center;font-size: 12px;line-height: 16px;color: #000000;margin-top: 20px;">
            Connect – це інформаційна онлайн-платформа для пошуку косметологів. Платформа не є закладом охорони здоров'я, не провадить медичну практику та не надає медичних послуг у розумінні поточного законодавства України. Уся інформація на сайті носить виключно інформаційний характер і не є медичною рекомендацією. Платформа не несе відповідальності за якість, безпеку або результат косметологічних процедур – відповідальність за їх проведення несе виключно косметолог як самостійний суб'єкт господарювання.
        </p>
    </div>
</footer>
