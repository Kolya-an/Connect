...
<div id="home_search">
    <div class="container">
        <div class="home_search_block">
            <div class="home_search_bg _minwidth769"><img src="{{Vite::asset('resources/images/home_search_bg.png')}}" alt=""></div>
            <div class="home_banner">
                <svg width="59" height="59" viewBox="0 0 59 59" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="0.5" y="0.529785" width="58" height="58" rx="29" fill="#FFE7E8"/>
                    <path
                        d="M29.5 38.8798L28.05 37.5598C22.9 32.8898 19.5 29.7998 19.5 26.0298C19.5 22.9398 21.92 20.5298 25 20.5298C26.74 20.5298 28.41 21.3398 29.5 22.6098C30.59 21.3398 32.26 20.5298 34 20.5298C37.08 20.5298 39.5 22.9398 39.5 26.0298C39.5 29.7998 36.1 32.8898 30.95 37.5598L29.5 38.8798Z"
                        fill="black"/>
                </svg>
                ...
                <div class="home_search_bg_mob _maxwidth768"><img src="{{Vite::asset('resources/images/home_search_bg_mob.png')}}" alt=""></div>
            </div>
                ...
                <form id="doc_search_form" class="_flex-display _justify-content-between _align-center">
                    ...
                    <div class="_flex-display field_section city_field_section">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25"
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                  d="M14.5 11.0005C14.5 9.61924 13.3808 8.5 12.0005 8.5C10.6192 8.5 9.5 9.61924 9.5 11.0005C9.5 12.3808 10.6192 13.5 12.0005 13.5C13.3808 13.5 14.5 12.3808 14.5 11.0005Z"
                                  stroke="#25324B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                  d="M11.9995 21.5C10.801 21.5 4.5 16.3984 4.5 11.0633C4.5 6.88664 7.8571 3.5 11.9995 3.5C16.1419 3.5 19.5 6.88664 19.5 11.0633C19.5 16.3984 13.198 21.5 11.9995 21.5Z"
                                  stroke="#25324B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    ...
                    <div class="_flex-display field_section radius_field_section">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25"
                             fill="none">
                            <path
                                d="M12 4.5C14.2 4.5 16 6.3 16 8.5C16 10.6 13.9 14 12 16.4C10.1 13.9 8 10.6 8 8.5C8 6.3 9.8 4.5 12 4.5ZM12 2.5C8.7 2.5 6 5.2 6 8.5C6 13 12 19.5 12 19.5C12 19.5 18 12.9 18 8.5C18 5.2 15.3 2.5 12 2.5ZM12 6.5C10.9 6.5 10 7.4 10 8.5C10 9.6 10.9 10.5 12 10.5C13.1 10.5 14 9.6 14 8.5C14 7.4 13.1 6.5 12 6.5ZM20 19.5C20 21.7 16.4 23.5 12 23.5C7.6 23.5 4 21.7 4 19.5C4 18.2 5.2 17.1 7.1 16.3L7.7 17.2C6.7 17.7 6 18.3 6 19C6 20.4 8.7 21.5 12 21.5C15.3 21.5 18 20.4 18 19C18 18.3 17.3 17.7 16.2 17.2L16.8 16.3C18.8 17.1 20 18.2 20 19.5Z"
                                fill="black"/>
                        </svg>
        ...
        <div class="_flex-display _justify-content-between _align-stretch top_docs">
            <div class="top_docs_preview doc_number_one">
                <div class="doc_number_one_image">
                    <img src="{{Vite::asset('resources/images/number-one.png')}}" alt="">
                </div>
                ...
                <div class="_flex-display _justify-content-between _align-center top_docs-rating_city">
                    ...
                    <div class="_flex-display _align-bottom top_docs-city">
                        <svg width="11" height="13" viewBox="0 0 11 13" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                  d="M7 5.6004C7 4.77164 6.32846 4.1001 5.5003 4.1001C4.67154 4.1001 4 4.77164 4 5.6004C4 6.42856 4.67154 7.1001 5.5003 7.1001C6.32846 7.1001 7 6.42856 7 5.6004Z"
                                  stroke="black" stroke-linecap="round" stroke-linejoin="round"/>
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                  d="M5.49971 11.9001C4.78062 11.9001 1 8.83912 1 5.63807C1 3.13208 3.01426 1.1001 5.49971 1.1001C7.98515 1.1001 10 3.13208 10 5.63807C10 8.83912 6.21879 11.9001 5.49971 11.9001Z"
                                  stroke="black" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        <p><b>м. Київ</b></p>
                    </div>
            ...
            <div class="_flex-display _justify-content-center top_docs_buttons">
                <div class="_flex-display _justify-content-center _align-center carousel_btn carousel_btn_prev">
                    <svg xmlns="http://www.w3.org/2000/svg" width="6" height="8" viewBox="0 0 6 8" fill="none">
                        <path d="M4.56 8L5.5 7.06L2.44667 4L5.5 0.94L4.56 8.21774e-08L0.56 4L4.56 8Z"
                              fill="#F396A2"/>
                    </svg>
                </div>
                <div class="_flex-display _justify-content-center _align-center carousel_btn carousel_btn_next">
...
<div id="platform">
    <div class="container">
        ...
        <h1><span class="h1-title">Connect Cosmetology <span class="h1-line"><svg xmlns="http://www.w3.org/2000/svg"
                                                                                  width="255" height="14"
                                                                                  viewBox="0 0 255 14" fill="none">
<path d="M0.5 12L254 2" stroke="#F396A2" stroke-width="3"/>
</svg></span></span>- це твоя платформа з пошуку свого косметолога
        </h1>
        <div class="_flex-display _justify-content-between _align-stretch platform-block">
            <div class="platform-modals">
                <div
                    class="_flex-display _justify-content-between _align-stretch platform-modal platform-modal-top">
                    <div class="_flex-display _justify-content-between platform-modal-grey">
                        <div class="_flex-display _justify-content-between _align-center">
                            <div class="_flex-display _justify-content-center _align-center platform-about_plate">
                                Про нас
                            </div>
                            <a href="#">
                                <svg width="26" height="25" viewBox="0 0 26 25" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M0 12.5C0 5.59644 5.59644 0 12.5 0H13.5C20.4036 0 26 5.59644 26 12.5C26 19.4036 20.4036 25 13.5 25H12.5C5.59644 25 0 19.4036 0 12.5Z"
                                        fill="white"/>
                                    <path
                                        d="M7.33104 16.2567C6.92053 16.6262 6.88725 17.2585 7.25671 17.669C7.62616 18.0795 8.25845 18.1128 8.66896 17.7433L7.33104 16.2567ZM18.9986 8.05256C19.0276 7.50104 18.6041 7.03041 18.0526 7.00138L9.065 6.52835C8.51348 6.49932 8.04285 6.92289 8.01382 7.47441C7.98479 8.02593 8.40836 8.49656 8.95988 8.52559L16.9488 8.94606L16.5284 16.935C16.4993 17.4865 16.9229 17.9572 17.4744 17.9862C18.0259 18.0152 18.4966 17.5916 18.5256 17.0401L18.9986 8.05256ZM8 17L8.66896 17.7433L18.669 8.74329L18 8L17.331 7.25671L7.33104 16.2567L8 17Z"
                                        fill="black"/>
                                </svg>
                            </a>
                        </div>
                        <div class="platform-about-text">
                            <p>Відкривай мапу, вводь необхідні параметри у фільтр, шукай свого косметолога за
                                рейтингом, процедурою або по фото його робіт. </p>
                            <p>Заходь у фотобанк, дивись роботи фахівців, обери зміни, які ти прагнеш побачити у
                                себе на обличчі, читай, що було зроблено, клікай на надпис під фото і переходь на
                                сторінку фахівця, автора змін.</p>
                        </div>
                    </div>
                    <div class="platform-modal-rose"></div>
                </div>
                <div
                    class="_flex-display _justify-content-between _align-stretch platform-modal platform-modal-bottom _minwidth769">
                    <div class="_flex-display _justify-content-between _align-bottom platform-modal-rose">
                        <div class="_flex-display _justify-content-center _align-center platform-photo_plate">
                            Фотобанк
                        </div>
                        <a href="#">
                            <svg width="26" height="25" viewBox="0 0 26 25" fill="none"
                    ...
                    <div class="platform-modal-grey">
                        <div class="_flex-display _justify-content-between _align-center">
                            <div class="_flex-display _justify-content-center _align-center platform-action_plate">
                                Акція
                            </div>
                            <a href="#">
                                <svg width="26" height="25" viewBox="0 0 26 25" fill="none"
                        ...
                        <div class="_flex-display _justify-content-between _align-center platform-action-bottom">
                            <div class="platform-action-image"><img src="{{Vite::asset('resources/images/platform-action-image.png')}}" alt=""/>
                            </div>
                            <div class="platform-action-text">
                                ...
                                <div
                                    class="_flex-display _justify-content-between _align-center top_docs-rating_city">
                                    <div class="_flex-display _align-center top_docs-rating">
                                    ...
                                    <div class="_flex-display _align-center top_docs-city">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="11" height="13"
                                            ...
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                  d="M7 5.60028C7 4.77152 6.32846 4.09998 5.5003 4.09998C4.67154 4.09998 4 4.77152 4 5.60028C4 6.42843 4.67154 7.09998 5.5003 7.09998C6.32846 7.09998 7 6.42843 7 5.60028Z"
                                                  stroke="black" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                  d="M5.49971 11.9C4.78062 11.9 1 8.839 1 5.63795C1 3.13196 3.01426 1.09998 5.49971 1.09998C7.98515 1.09998 10 3.13196 10 5.63795C10 8.839 6.21879 11.9 5.49971 11.9Z"
                                                  stroke="black" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                        <p><b>м. Київ</b></p>
                                    </div>
            ...
            <div
                class="_flex-display _justify-content-between _align-stretch platform-modal platform-modal-bottom _maxwidth768">
                <div class="platform-modal-grey">
                    <div class="_flex-display _justify-content-between _align-center">
                        <div class="_flex-display _justify-content-center _align-center platform-action_plate">
                            Акція
                    ...
                    <div class="_flex-display _justify-content-between _align-center platform-action-bottom">
                        <div class="platform-action-image"><img src="{{Vite::asset('resources/images/platform-action-image.png')}}" alt=""/></div>
                        <div class="platform-action-text">
                            <p class="platform-action-title">-20% на першу процедуру</p>
                            <p>Збільшення губ, Біоревіталізація, Чистка, Пілінг</p>
                            <div class="fio_doc_spec">
                ...
                <div class="_flex-display _justify-content-center _align-bottom platform-modal-rose">
                    <div class="_flex-display _justify-content-center _align-center platform-photo_plate">Фотобанк
                    </div>
                    <a href="#">
                        <svg width="26" height="25" viewBox="0 0 26 25" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="_flex-display _justify-content-between _align-stretch home-articles-list">
            <div class="article first-article _minwidth769">
                <div class="article-image">
                    <img src="{{Vite::asset('resources/images/a1.jpg')}}" alt=""/>
                </div>
                <a class="_flex-display _justify-content-between _align-center article_title" href="#"><h5>SPF, як
                        обрати? Поради лікаря</h5>
                    <svg width="36" height="35" viewBox="0 0 36 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M0 17.5C0 7.83502 7.83502 0 17.5 0H18.5C28.165 0 36 7.83502 36 17.5C36 27.165 28.165 35 18.5 35H17.5C7.83502 35 0 27.165 0 17.5Z"
                            fill="#F396A2"/>
                        <path
                            d="M12.331 21.2567C11.9205 21.6262 11.8872 22.2585 12.2567 22.669C12.6262 23.0795 13.2585 23.1128 13.669 22.7433L12.331 21.2567ZM23.9986 13.0526C24.0276 12.501 23.6041 12.0304 23.0526 12.0014L14.065 11.5284C13.5135 11.4993 13.0428 11.9229 13.0138 12.4744C12.9848 13.0259 13.4084 13.4966 13.9599 13.5256L21.9488 13.9461L21.5284 21.935C21.4993 22.4865 21.9229 22.9572 22.4744 22.9862C23.0259 23.0152 23.4966 22.5916 23.5256 22.0401L23.9986 13.0526ZM13 22L13.669 22.7433L23.669 13.7433L23 13L22.331 12.2567L12.331 21.2567L13 22Z"
                            fill="white"/>
                    </svg>
                </a>
            ...
            <div class="home-articles-right">
                ...
                <div class="_flex-display _justify-content-between _align-stretch home-articles-23">
                    <div class="article _maxwidth768">
                        ...
                        <a class="_flex-display _justify-content-between _align-center article_title" href="#"><h5>
                                SPF, як обрати? Поради лікаря</h5>
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur. Neque leo morbi viverra cursus quam quam
                            malesuada.</p>
                    </div>
                    <div class="article">
                        <div class="article-image">
                            <img src="{{Vite::asset('resources/images/a2.jpg')}}" alt=""/>
                        </div>
                        <a class="_flex-display _justify-content-between _align-center article_title" href="#"><h5>
                                Збільшення губ</h5>
                            <svg width="36" height="35" viewBox="0 0 36 35" fill="none"
                    ...
                    <div class="article">
                        <div class="article-image">
                            <img src="{{Vite::asset('resources/images/a3.jpg')}}" alt=""/>
                        </div>
                        <a class="_flex-display _justify-content-between _align-center article_title" href="#"><h5>
                                Ультразвукова чистка</h5>
                            <svg width="36" height="35" viewBox="0 0 36 35" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M0 17.5C0 7.83502 7.83502 0 17.5 0H18.5C28.165 0 36 7.83502 36 17.5C36 27.165 28.165 35 18.5 35H17.5C7.83502 35 0 27.165 0 17.5Z"
