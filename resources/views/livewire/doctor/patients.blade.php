        ...
        <div class="_flex-display _justify-content-center _align-center screen">
            <div class="window add_info_window">
                <div class="_flex-display _justify-content-between _align-center window_top">
                 ...
                 <textarea
                    wire:model.live="patientInformation"
                ...
                <label class="_flex-display _align-top more_filter_checkbox" style="flex-wrap: nowrap;">
                    ...
                    <input id="doc_pac_information" type="checkbox" wire:model.live="doc_pac_information">
                    <span class="checkmark"></span>
                    <span class="check_title" style="width: calc(100% - 30px);">Я ознайомився(лась) з <a target="_blank" href="/instrukciia-dlia-specialistiv-shhodo-roboti-z-danimi-koristuvaciv-u-sistemi-connect-cosmetology">Інструкцією для косметологів щодо роботи з даними пацієнтів у системі</a></span>
                </label>
                
                <label class="_flex-display _align-top more_filter_checkbox" style="flex-wrap: nowrap;">
                   
                    <input id="doc_pac_confirmation" type="checkbox" wire:model.live="doc_pac_confirmation">
                    <span class="checkmark"></span>
                    <span class="check_title" style="width: calc(100% - 30px);">{{ __('Підтверджую, що маю належну правову підставу для внесення цих даних пацієнта до системи та проінформував(ла) пацієнта про таку обробку') }}</span>
                </label>
                 ...
                 <div class="_flex-display _justify-content-center _align-center">
                     <div class="_flex-display _align-center spec_register_buttons">
                         ...
                         <button 
                             type="button" 
                             wire:click="savePatientInformation" 
                             class="rose_btn register_prev" 
                             @disabled(!$doc_pac_information || !$doc_pac_confirmation)
                         >
                             {{__('Зберегти')}}
                         </button>
                     </div>
    ...
    <div class="_flex-display _justify-content-center _align-center screen">
        <div class="window add_info_window">
            ...
            <label class="_flex-display _align-top more_filter_checkbox" style="flex-wrap: nowrap;">
                ...
                <input id="doc_his_information" type="checkbox" wire:model.live="doc_his_information">
                <span class="checkmark"></span>
                <span class="check_title" style="width: calc(100% - 30px);">Я ознайомився(лась) з <a target="_blank" href="/instrukciia-dlia-specialistiv-shhodo-roboti-z-danimi-koristuvaciv-u-sistemi-connect-cosmetology">Інструкцією для косметологів щодо роботи з даними пацієнтів у системі</a></span>
            </label>
            ...
            <label class="_flex-display _align-top more_filter_checkbox" style="flex-wrap: nowrap;">
                ...
                <input id="doc_his_confirmation" type="checkbox" wire:model.live="doc_his_confirmation">
                <span class="checkmark"></span>
                <span class="check_title" style="width: calc(100% - 30px);">{{ __('Підтверджую, що маю належну правову підставу для внесення цих даних пацієнта до системи та проінформував(ла) пацієнта про таку обробку') }}</span>
            </label>
            ...
            <div class="_flex-display _justify-content-center _align-center">
                <div class="_flex-display _align-center spec_register_buttons">
                    ...
                    <button 
                        type="button" 
                        wire:click="completedAppointment" 
                        class="rose_btn register_prev"
                        @disabled(!$doc_his_information || !$doc_his_confirmation)
                    >
                        {{__('Зберегти')}}
                    </button>
                </div>
