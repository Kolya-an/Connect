            ...
            <div class="search_column">
                <div class="search_banner">
                    ...
                    <div class="_flex-display _align-center home_banner_bottom">
                        <div class="_flex-display _align-center home_banner_images"><img src="image/home_banner_images.png" alt=""></div>
                    ...
                    <div class="home_search_bg _minwidth769"><img src="image/search_banner.png" alt=""></div>
                </div>
                <div class="search_form">
                    <form id="search" class="_flex-display _justify-content-between _align-center search_form">
                        ...
                        <div class="search_field search_field_input">
                            <input id="search_search" class="search_search" type="text" placeholder="Пошук процедури, салону, майстра" name="search" />
                        </div>
                        <div class="search_field search_field_rating">
                            <select id="search_rating" class="search_rating" name="rating">
                                <option value="">Рейтинг лікаря</option>
                        ...
                        <div id="more_filter">Ще фільтри<div id="numb_filter" class="_flex-display _justify-content-center _align-center _display_none">0</div></div>
                        <button type="submit" class="btn rose_btn submit_button">Знайти</button>
                        <div id="more_filter_block" class="_display_none">
                            ...
                            <div class="_flex-display _justify-content-between _align-center more_filter_selects">
                                <div id="area_metro" class="_flex-display _align-center">
                                    <div class="area_metro_title">Район/Метро</div>
                                    ...
                                    <div class="_display_none area_metro_block">
                                        <div class="_flex-display _align-center area_metro_tabs">
                                            <div id="area_tab" class="_flex-display _align-center rose_btn area_metro_tab">Район</div>
                                            <div id="metro_tab" class="_flex-display _align-center white_rose_btn area_metro_tab">Метро</div>
                                        </div>
                                        <div id="area_block">
                                            <ul>
                                                <li>Голосiївський</li>
                                ...
                                <div class="search_field search_field_sex">
                                    <select id="search_sex" class="search_sex" name="sex">
                                        <option value="">Стать лікаря</option>
                            ...
                            <div class="_flex-display more_filter_numb_checkbox">
                                ...
                                <div class="_flex-display _align-center more_filter_checkboxes">
                                    <label class="_flex-display _align-center more_filter_checkbox">
                                        ...
                                        <span class="check_title">Знижка</span>
                                    </label>
                                    <label class="_flex-display _align-center more_filter_checkbox">
                                        <input id="check_gift" type="checkbox" name="gift">
                                        <span class="checkmark"></span>
                                        <span class="check_title">Подарунок</span>
                                    </label>
                                    <label class="_flex-display _align-center more_filter_checkbox">
                                        <input id="check_home" type="checkbox" name="home">
                                        <span class="checkmark"></span>
                                        <span class="check_title">Виїзд додому</span>
                                    </label>
                                </div>
                            </div>
                            <div class="_flex-display _justify-content-between _align-center more_filter_buttons">
                                <div id="clear_search" class="btn white_rose_btn clear_button">Очистити</div>
                                <div id="apply_search" class="btn rose_btn apply_button">Застосувати</div>
                            </div>
                        </div>
                    </form>
                </div>
                <div class="_flex-display _align-center sort_block">
                    ...
                    <div class="search_field sort">
                        <select id="sort" class="sort" name="sort">
                            <option value="rating">за рейтингом лікаря</option>
                            <option value="cheaper">дешевше</option>
                ...
                <div class="doctors">
                    @if(count($doctors) == 0)
                        <p>Немає лікарів у цьому радіусі.</p>
                    @else
                    ...
                    <div class="_flex-display _justify-content-between doctor">
                        <div class="doctor_left">
                            ...
                            <div class="doctor_left_bottom">
                                ...
                                <div class="city_map _minwidth769">
                                    ...
                                    <a class="doctor_left_link" href="#">{{__('Відгуки')}}</a>
                                    ...
                                    <a class="doctor_left_link" href="#">{{__('Дивитись на карті')}}</a>
                                </div>
                        ...
                        <div class="doctor_right">
                            ...
                            <div class="_flex-display _justify-content-between _align-center doctors_buttons">
                                <a class="btn white_rose_btn all_services_button">{{__('Усі послуги')}}</a>
                                <a class="btn rose_btn save_button">{{__('Записатись')}}</a>
                            </div>
                        </div>
                    </div>
                        @endforeach
